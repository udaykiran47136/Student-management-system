...
class Student:
    def __init__(self,root):
        ...
        self.student_table.column("jan",width=80)
        self.student_table.column("feb",width=80)
        self.student_table.column("mar",width=80)
        self.student_table.column("apr",width=80)
        self.student_table.column("may",width=80)
        self.student_table.column("jun",width=80)
        self.student_table.column("jul",width=80)
        self.student_table.column("aug",width=80)
        self.student_table.column("sep",width=80)
        self.student_table.column("oct",width=80)
        self.student_table.column("nov",width=80)
        self.student_table.column("dec",width=80)
    ...
    def search_data(self):
        ...
        search_value = str(self.search_txt.get())
        cur.execute("select * from students where "+search_column+" LIKE ?", ("%"+search_value+"%",))
        rows = cur.fetchall()
        if len(rows)!=0:
            self.student_table.delete(*self.student_table.get_children())
            for row in rows:
